...
/// is gone, keep them online across a heartbeat, and refuse a guest outright. No Orleans, no Mongo,
/// no Redis — a <see cref="FakePresence"/> stands in for the port.
/// </summary>
public class LobbyHubTests
{
    ...
    {
        await using var host = new LobbyHubTestHost();
